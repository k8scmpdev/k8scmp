...
//    private HostEnv hostEnv;
    ...
    public DeploymentAlarmInfo(String id, String clusterName, String deploymentName, String namespace, HostEnv hostEnv,
                               String instanceName, String instanceHostIp, String instanceCreateTime, String containerId) {
        this.id = id;
