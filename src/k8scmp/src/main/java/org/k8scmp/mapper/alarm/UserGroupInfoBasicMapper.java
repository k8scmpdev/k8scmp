...
public interface UserGroupInfoBasicMapper {
    ...
    UserGroupBasic getUserGroupInfoBasicById(@Param("id") int id);
    ...
    int deleteUserGroupInfoBasicById(@Param("id") int id);
    ...
    List<UserGroupBasic> listUserGroupInfoBasicByTemplateId(@Param("templateId") int templateId);
}
