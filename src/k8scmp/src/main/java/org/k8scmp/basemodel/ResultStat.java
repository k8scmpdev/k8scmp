...
public enum ResultStat {
    ...
    // service related
    SERVICE_NOT_LEGAL(1200),
    SERVICE_NOT_EXIST(1201),
    CANNOT_DELETE_SERVICE(1202),
    SERVICE_EXIST(1203),
    SERVICE_STOP_FAILED(1204),
    SERVICE_START_FAILED(1205),
    SERVICE_GETVERSION_FAILED(1206),
    SERVICE_STATUS_NOT_ALLOW(1207),
    SERVICE_ABORT_EVENT_FAILED(1208),
    APPLICATION_NOT_LEGAL(1209),
    APPLICATION_NOT_EXIST(1210),
    SERVICE_IN_APPLICATION(1211),
    CANNOT_DELETE_APPLICATION(1212),
    APPLICATION_EXIST(1213),
    ...
    // serviceRuntime related
    SERVICERUNTIME_NOT_EXIST(1701),

    // instance related
    INSTANCE_NOT_EXIST(1801),

    SERVICEINFO_NOT_EXIST(1801),
